...
//------------------------------------------------------------------------------
	...
	$.fn.lobiPanel.DEFAULTS = {
		...
		unpin: {
			icon: 'icon-move', //You can user glyphicons if you do not want to use font-awesome
			tooltip: 'Unpin'               //tooltip text, If you want to disable tooltip, set it to false
		},
		reload: {
			icon: 'icon-loader', //You can user glyphicons if you do not want to use font-awesome
			tooltip: 'Reload'           //tooltip text, If you want to disable tooltip, set it to false
		},
		minimize: {
			icon: 'icon-minus4', //icon is shown when panel is not minimized
			icon2: 'icon-plus3', //icon2 is shown when panel is minimized
			tooltip: 'Minimize'         //tooltip text, If you want to disable tooltip, set it to false
		},
		expand: {
			icon: 'icon-popout', //icon is shown when panel is not on full screen
			icon2: 'icon-popin', //icon2 is shown when pane is on full screen state
			tooltip: 'Fullscreen'       //tooltip text, If you want to disable tooltip, set it to false
		},
		close: {
			icon: 'icon-circle-with-cross', //You can user glyphicons if you do not want to use font-awesome
